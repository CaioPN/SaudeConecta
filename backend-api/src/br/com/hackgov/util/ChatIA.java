...
public final class ChatIA {
    ...
    private static final String INSTRUCAO =
          ...
          + "temporário que libera os dados para o médico no atendimento.\n\n"
          + "O QUE O APP NÃO FAZ (nunca prometa isso): ele não agenda consulta nem marca exame — a "
          + "tela de consultas só mostra as que já existem, e o agendamento é feito direto com a "
          + "unidade de saúde. Também não recebe arquivo nem foto de exame enviada pelo paciente: "
          + "quem registra consulta, exame e prontuário é o médico, pelo código de acesso.\n\n"
          + "REGRAS OBRIGATÓRIAS:\n"
